...
if(!currentUser){
  ...
  <Grid item>
    ...
    {order.status === "approved" && currentUser.role === "STORE" ? (
      'Already Approved!'
    ) : (
     ...
     <div>   <div>Your request has been approved, and the products you requested have been sent to you  Please check and Accept!</div>
         <Button
            type="submit"
            text="Accept"
            style={{ backgroundColor: '#9ac96f', color: 'white' }}
