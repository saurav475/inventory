...
//tets case to return all users
 ...
 it('should return single user', async () => {
  ...
  expect(user?.username).toBe('sourav');
  expect(user?.email).toBe('sourav@gmail.com');  
});
it('should update a user', async () => {
  ...
  expect(updatedUser.username).toBe('sourav');
  expect(updatedUser.email).toBe('sourav@example.com');
});
